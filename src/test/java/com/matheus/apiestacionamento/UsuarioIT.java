...
public class UsuarioIT {
    ...
    public void createUsuario_ComUsernameEPasswordValidos_RetornarUsuarioCriadoComStatus201() {
        UsuarioResponseDto responseBody = webClient
                ...
                .bodyValue(new UsuarioCreateDto("tody@email.com", "101010"))
                .exchange()
    ...
    @Test
    public void createUsuario_ComUsernameInvalido_RetornarErrorMenssageStatus422() {
        ErrorMessage responseBody = webClient
                .post()
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioCreateDto("", "101010"))
                .exchange()
        ...
        responseBody = webClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioCreateDto("tody@", "101010"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
        ...
        responseBody = webClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioCreateDto("tody@email.", "101010"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    @Test
    public void createUsuario_ComPasswordInvalido_RetornarErrorMenssageStatus422() {
        ErrorMessage responseBody = webClient
                .post()
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
        ...
        responseBody = webClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioCreateDto("tody@email.com", "10101"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
        ...
        responseBody = webClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioCreateDto("tody@email.com", "1010101"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
    ...
    public void createUsuario_ComUsernameRepetido_RetornarErrorMessageComStatus409() {
        ...
        ErrorMessage responseBody = webClient
                ...
                .uri("/api/v1/usuarios")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioCreateDto("ana@email.com", "353535"))
                .exchange()
    ...
    public void buscarUsuario_ComIdExistente_RetornarUsuarioComStatus200() {
        UsuarioResponseDto responseBody = webClient
                ...
                .headers(JwtAuthentication.getAuthorizationHeader(webClient, "ana@email.com", "353535"))
                .exchange()
                .expectStatus().isOk()
                .expectBody(UsuarioResponseDto.class)
                .returnResult().getResponseBody();
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.getUsername()).isEqualTo("mariana@email.com");
        org.assertj.core.api.Assertions.assertThat(responseBody.getRole()).isEqualTo("CLIENTE");
    ...
    public void editarSenha_ComDadosValidos_RetornarStatus204() {
        webClient
                ...
                .headers(JwtAuthentication.getAuthorizationHeader(webClient, "ana@email.com", "353535"))
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaDto("353535", "101010", "101010"))
                .exchange()
        ...
        webClient
                ...
                .headers(JwtAuthentication.getAuthorizationHeader(webClient, "mariana@email.com", "343434"))
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UsuarioSenhaDto("343434", "101010", "101010"))
                .exchange()
                .expectStatus().isNoContent();
    }
    ...
    public void listarUsuarios_SemQualquerParametro_RetornarListaDeUsuariosComStatus200() {
        ...
        ParameterizedTypeReference<List<UsuarioResponseDto>> responseType =
                new ParameterizedTypeReference<List<UsuarioResponseDto>>() {};


        List<UsuarioResponseDto> responseBody = webClient
                .get()
                .uri("/api/v1/usuarios")
                .headers(JwtAuthentication.getAuthorizationHeader(webClient, "ana@email.com", "353535"))
                .exchange()
