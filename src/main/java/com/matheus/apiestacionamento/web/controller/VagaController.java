...
@Tag(name = "Vagas", description = "Contem todos os recursos relativos ao recurso de uma vaga")
...
public class VagaController {
    ...
    @Operation(
            ...
            "Reuisição exige uso do bearer token. Acesso restrito a Role='ADMIN'",
            security = @SecurityRequirement(name = "security"),
            responses = {
                    @ApiResponse(responseCode = "201", description = "Recurso criado com sucesso",
                            headers = @Header(name = HttpHeaders.LOCATION, description = "URI do recurso criado")),
                    @ApiResponse(responseCode = "409", description = "Vaga ja cadastrada no sistema",
